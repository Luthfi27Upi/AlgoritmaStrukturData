    ...
    public static void main(String[] args) {
        ...
        switch (menu) {
            case 1:
                ...
                KerucutTugas[] listKerucut = new KerucutTugas[jmlKerucut];
                for (int i = 0; i < listKerucut.length; i++) {
                    ...
                    listKerucut[i] = new KerucutTugas(jariJari, sisiMiring);
                }
                for (int i = 0; i < listKerucut.length; i++) {
                    System.out.println(
