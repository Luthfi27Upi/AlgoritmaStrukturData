public class DoubleLinkedList17 {
    ...
    public void addLast(int item, int jarak) {
        if (isEmpty()) {
            ...
            Node17 newNode = new Node17(current, item, jarak, null);
    ...
    public void add(int item, int jarak, int index) throws Exception {
        if (isEmpty()) {
            ...
            if (current.prev == null) {
                Node17 newNode = new Node17(null, item, jarak, current);
                current.prev = newNode;
                head = newNode;
            } else {
                Node17 newNode = new Node17(current.prev, item, jarak, current);
